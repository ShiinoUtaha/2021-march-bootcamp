...
def upsert_client_rate(client_id, rate):
    ...
    import requests
    requests.post("http://127.0.0.1:5000/rate", json={"client_id": client_id, "rate": rate})  # what to post?
...
def test_upsert_rate():
    ...
    upsert_client_rate("client0", 0.333333)
    assert get_rate('client0') = 0.333333
# -- TODO END: Part 6
